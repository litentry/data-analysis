...
export class BitTorrent extends ethereum.SmartContract {
  static bind(address: Address): BitTorrent {
    return new BitTorrent("BitTorrent", address);
  }
  ...
  calcFee(_value: BigInt): BigInt {
    let result = super.call("calcFee", "calcFee(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(_value)
    ]);
  ...
  try_calcFee(_value: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall("calcFee", "calcFee(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(_value)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  oldBalanceOf(who: Address): BigInt {
    let result = super.call("oldBalanceOf", "oldBalanceOf(address):(uint256)", [
      ethereum.Value.fromAddress(who)
    ]);
  ...
  try_oldBalanceOf(who: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "oldBalanceOf",
